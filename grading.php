    ...
    <div class="content">
        ...
        <div class="summary width">
            <div class="internal full">
                <h1>Exams grading center</h1>
                <!-- <a href="tablecreate.php">Create exam table</a> -->
                <!-- <a href="">delete exam table</a> -->
                <a href="./resultsadd.php">add  results records</a>
            </div>
        </div> 
    </div>
</div>
